...
def app():
    ...
    with st.form("Application Setup"):
        ...
        st.write("###### Hello there! Welcome to SocialSync. Since this is your first time running the app, we need to set up encryption :)")
        ...
        st.write("###### SocialSync uses S3 to store much of the saved data for this application. All of it's encrypted locally with the key mentioned above before being sent to the server. You can use a service like Storj.io to create S3 credentials in minutes; more info avaiable on the GitHub page.")
